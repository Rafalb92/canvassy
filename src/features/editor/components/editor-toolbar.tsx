...
export const EditorToolbar = ({
  ...
  const initialFontWeight =
    editor?.getActiveFontWeight() || FONT_WEIGHT;
  const initialFontStyle = editor?.getActiveFontStyle();
  const initialFontLinethrough =
    editor?.getActiveFontLinethrough();
  const initialFontUnderline =
    editor?.getActiveFontUnderline();
  const initialTextAlign = editor?.getActiveTextAlign();
  const initialFontSize =
    editor?.getActiveFontSize() || FONT_SIZE;
        ...
        <>
          <div className="flex items-center h-full justify-center">
            ...
            >
              ...
              >
                <TbColorFilter className="size-4 shrink-0 ml-2" />
              </Button>
            </Hint>
          </div>
          <div className="flex items-center h-full justify-center">
            ...
            >
              ...
              >
                <SquareSplitHorizontal className="size-4 shrink-0 ml-2" />
              </Button>
            </Hint>
          </div>
        </>
